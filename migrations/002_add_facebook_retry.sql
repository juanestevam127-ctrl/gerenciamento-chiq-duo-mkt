...
ALTER TABLE "chiquinho_sorvetes_controle_postagens"
...
ALTER TABLE "chiquinho_sorvetes_clientes"
...
CREATE TABLE IF NOT EXISTS webhook_retry_log (
  ...
  FOREIGN KEY (id_instagram) REFERENCES "chiquinho_sorvetes_clientes"(id_instagram) ON DELETE CASCADE
);
